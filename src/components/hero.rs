    ...
    rsx! {
        div {
            ...
            div {
                id: "links",
                a { 
                    href: "https://mastodon.art/@Pandenko", target: "_blank", rel: "noopener noreferrer", 
                    // img {
                ...
                a {
                    href: "https://www.youtube.com/@pandenko", target: "_blank", rel: "noopener noreferrer",
                    // img {
                ...
                a { href: "https://www.instagram.com/valentin_pandenko/", target: "_blank", rel: "noopener noreferrer", 
                    // img { 
